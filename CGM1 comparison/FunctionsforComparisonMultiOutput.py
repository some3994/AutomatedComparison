...
##############################################################################
def PelvisTilt(k1,k2,method1,method3):
    i1 = findbodypart('LPelvis',method1,k1)
    i2 = findbodypart('LPelvis',method3,k2)
    
    pelvis1,pelvis2 = datatake(method1,method3,i1,i2,0,1)
...
def PelvisTilt1(**args,**methods):
    ...
    for method in methods:
        for k in args:
            i[arg] = findbodypart('LPelvis',method,k)

        for x in range(len(i)):
            pelvis[x] = datatake(method,i[x],0)
    #0 to extract data at normal index 1, 1 to extract data at normal index
    #2 and etc.. Don't @me lol @python
    #As the angles are defined as oppisites, use diffcalcadjustment1
            PelvTiltDif[x] = differencecalc(pelvis[0],pelvis[x])
...
def PelvisOb(k1,k2,method1,method3):
    i1 = findbodypart('LPelvis',method1,k1)
    i2 = findbodypart('LPelvis',method3,k2)
    
    pelvis1,pelvis2 = datatake(method1,method3,i1,i2,1,0)
    
    PelvObDif = differencecalc(pelvis1,pelvis2)
    #Test_Dif = PelvObDif[k1+10]
...
#    elif Test_Dif>90 and Test_Dif<180:
#        PelvObDif = diffcalcadjustment2(pelvis1,pelvis2,k1)
...
def PelvisRot(k1,k2,method1,method3):
    i1 = findbodypart('LPelvis',method1,k1)
    i2 = findbodypart('LPelvis',method3,k2)
    pelvis1,pelvis2 = datatake(method1,method3,i1,i2,2,2)
...
def HipFlex(k1,k2,method1a,method2a):
    i1 = findbodypart('LHipAngles',method1a,k1)
    i2 = findbodypart('LHipAngles',method2a,k2)
    
    lhip1,lhip2 = datatake(method1a,method2a,i1,i2,0,0)
    ...
    i1 = findbodypart('RHipAngles',method1a,k1)
    i2 = findbodypart('RHipAngles',method2a,k2)
    
    rhip1,rhip2 = datatake(method1a,method2a,i1,i2,0,0)
...
def Hipadduct(k1,k2,method1a,method2a):      
    i1 = findbodypart('LHipAngles',method1a,k1)
    i2 = findbodypart('LHipAngles',method2a,k2)
    
    lhip1,lhip2 = datatake(method1a,method2a,i1,i2,1,1)
    ...
    i1 = findbodypart('RHipAngles',method1a,k1)
    i2 = findbodypart('RHipAngles',method2a,k2) 
    rhip1,rhip2 = datatake(method1a,method2a,i1,i2,1,1)
...
def Hiprot(k1,k2,method1a,method2a):      
    i1 = findbodypart('LHipAngles',method1a,k1)
    i2 = findbodypart('LHipAngles',method2a,k2)
    lhip1,lhip2 = datatake(method1a,method2a,i1,i2,2,2)
    ...
    i1 = findbodypart('RHipAngles',method1a,k1)
    i2 = findbodypart('RHipAngles',method2a,k2)
    rhip1,rhip2 = datatake(method1a,method2a,i1,i2,2,2)
...
def kneeflex(k1,k2,method1a,method2a):
    i1 = findbodypart('LKneeAngles',method1a,k1)
    i2 = findbodypart('LKneeAngles',method2a,k2)
    
    lknee1,lknee2 = datatake(method1a,method2a,i1,i2,0,0)
    ...
    i1 = findbodypart('RKneeAngles',method1a,k1)
    i2 = findbodypart('RKneeAngles',method2a,k2)    
        
    rknee1,rknee2 = datatake(method1a,method2a,i1,i2,0,0)
...
def kneevarus(k1,k2,method1a,method2a):
    i1 = findbodypart('LKneeAngles',method1a,k1)
    i2 = findbodypart('LKneeAngles',method2a,k2)
    
    lknee1,lknee2 = datatake(method1a,method2a,i1,i2,1,1)
    ...
    rknee1,rknee2 = datatake(method1a,method2a,i1,i2,1,1)
...
def kneerot(k1,k2,method1a,method2a):
    i1 = findbodypart('LKneeAngles',method1a,k1)    
    i2 = findbodypart('LKneeAngles',method2a,k2)
    lknee1,lknee2 = datatake(method1a,method2a,i1,i2,2,2)
    ...
    rknee1,rknee2 = datatake(method1a,method2a,i1,i2,2,2)
...
def Ankleflex(k1,k2,method1a,method2a):
    i1 = findbodypart('LAnkleAngles',method1a,k1)
    i2 = findbodypart('LAnkleAngles',method2a,k2)
    lank1,lank2 = datatake(method1a,method2a,i1,i2,0,0)
    ...
    i1 = findbodypart('RAnkleAngles',method1a,k1)
    i2 = findbodypart('RAnkleAngles',method2a,k2)
    rank1,rank2 = datatake(method1a,method2a,i1,i2,0,0)
...
def AnkleAdd(k1,k2,method1a,method2a):
    i1 = findbodypart('LAnkleAngles',method1a,k1)
    i2 = findbodypart('LAnkleAngles',method2a,k2)
    
    lank1,lank2 = datatake(method1a,method2a,i1,i2,2,2)
    ...
    i1 = findbodypart('RAnkleAngles',method1a,k1)
    i2 = findbodypart('RAnkleAngles',method2a,k2)    
    rank1,rank2 = datatake(method1a,method2a,i1,i2,2,2)
...
def FootProg(k1,k2,method1a,method2a):
    i1 = findbodypart('LFootProgress',method1a,k1)
    i2 = findbodypart('LFootProgress',method2a,k2)    
    lfoot1,lfoot2 = datatake(method1a,method2a,i1,i2,2)
    lfootprogDif = differencecalc(lfoot2,lfoot1)
    ...
    i1 = findbodypart('RFootProgress',method1a,k1)
    i2 = findbodypart('RFootProgress',method2a,k2)    
    rfoot1,rfoot2 = datatake(method1a,method2a,i1,i2,2,2)
    rfootprogDif = differencecalc(rfoot1,rfoot2)
...
def datapull1(k,n,file1,objectname):
    #for use of the special suffixes    
    method = []
    Temp = []
    
    for i in range(n-3):
        if objectname in file1.iloc[k,i]: 
            #if the special suffix is found, data extracted
            Temp.append(file1.iloc[k::,i])   #the columns are taken and stored
            Temp.append(file1.iloc[k::,i+1])
            Temp.append(file1.iloc[k::,i+2])
            if file1.iloc[k,i+3] == '0':
                Temp.append(file1.iloc[k::,i+3])
                Temp.append(file1.iloc[k::,i+4])
                Temp.append(file1.iloc[k::,i+5])
                Temp.append(file1.iloc[k::,i+6])
                Temp.append(file1.iloc[k::,i+7])
                Temp.append(file1.iloc[k::,i+8])
...
def floatconver3(method1a,k1,m1):    
    for i in range(len(method1a)):
        for j in range(k1+2,m1):        
            method1a[i][0][j] = float(method1a[i][0][j])
            method1a[i][1][j] = float(method1a[i][1][j])
            method1a[i][2][j] = float(method1a[i][2][j])
...
def datatake(method1,method2,i1,i2,x1,x2):
    data1 = method1[i1][x1][3::]
    data2 = method2[i2][x2][2::]
    return data1,data2

def datatake1(method1,i1,x1):
    data1 = method1[i1][x1][3::]
    return data1,data2
